            ...
            <div class="container">
                <div class="grid grid-cols-12 gap-x-6 gap-y-10">
                    <div class="col-span-12 sm:col-span-10 sm:col-start-2">
                         ...
                         <form action="{{route('admin.edit.opening', $opening->id)}}" enctype="multipart/form-data"
                            method="POST">
                                ...
                                <div class="box box--stacked flex flex-col">
                                    <div class="p-7">
                                        ...
                                        <div
                                            ...
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <div class="flex flex-col items-center md:flex-row">
                                                    <input data-tw-merge="" name="title" value="{{$opening?->title}}" type="text"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <div
                                                        class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                        Enter the type of job, eg. Full-time...
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <select name="type" id="countries-list"
                                                class="disabled:bg-slate-100 disabled:cursor-not-allowed dark:disabled:bg-darkmode-800/50 dark:disabled:border-transparent [&[readonly]]:bg-slate-100 [&[readonly]]:cursor-not-allowed [&[readonly]]:dark:bg-darkmode-800/50 [&[readonly]]:dark:border-transparent transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 dark:placeholder:text-slate-500/80 [&[type='file']]:border file:mr-4 file:py-2 file:px-4 file:rounded-l-md file:border-0 file:border-r-[1px] file:border-slate-100/10 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-500/70 hover:file:bg-200 group-[.form-inline]:flex-1 group-[.input-group]:rounded-none group-[.input-group]:[&:not(:first-child)]:border-l-transparent group-[.input-group]:first:rounded-l group-[.input-group]:last:rounded-r group-[.input-group]:z-10">
                                                ...
                                                <option value="contract" {{ $opening->type == 'contract' ? 'selected' : '' }}>Contract</option>
                                                <option value="internship" {{ $opening->type == 'internship' ? 'selected' : '' }}>Internship</option>
                                            </select>
                                            </div>
                                        </div>
                                         ...
                                         <div
                                            ...
                                            <div
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <div
                                                        class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                        Choose the status of the role.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <select name="status" id="countries-list"
                                                class="disabled:bg-slate-100 disabled:cursor-not-allowed dark:disabled:bg-darkmode-800/50 dark:disabled:border-transparent [&[readonly]]:bg-slate-100 [&[readonly]]:cursor-not-allowed [&[readonly]]:dark:bg-darkmode-800/50 [&[readonly]]:dark:border-transparent transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 dark:placeholder:text-slate-500/80 [&[type='file']]:border file:mr-4 file:py-2 file:px-4 file:rounded-l-md file:border-0 file:border-r-[1px] file:border-slate-100/10 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-500/70 hover:file:bg-200 group-[.form-inline]:flex-1 group-[.input-group]:rounded-none group-[.input-group]:[&:not(:first-child)]:border-l-transparent group-[.input-group]:first:rounded-l group-[.input-group]:last:rounded-r group-[.input-group]:z-10">
                                                <option selected disabled>-- Select --</option>

                                                <option value="open" {{ $opening->status == 'open' ? 'selected' : '' }}>Open</option>
                                                <option value="closed" {{ $opening->status == 'closed' ? 'selected' : '' }}>Closed</option>
                                                <option value="upcoming" {{ $opening->status == 'upcoming' ? 'selected' : '' }}>Upcoming</option>
                                        ...
                                        <div
                                            ...
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <input data-tw-merge="" id="autocompleteN" type="text" name="location" value="{{$opening?->location}}"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <div
                                                        class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                        Assign this company to an opening.
                                                    </div>
                                                </div>
                                            </div>
                                             <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <select name="company_id" id="countries-list"
                                                class="disabled:bg-slate-100 disabled:cursor-not-allowed dark:disabled:bg-darkmode-800/50 dark:disabled:border-transparent [&[readonly]]:bg-slate-100 [&[readonly]]:cursor-not-allowed [&[readonly]]:dark:bg-darkmode-800/50 [&[readonly]]:dark:border-transparent transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 dark:placeholder:text-slate-500/80 [&[type='file']]:border file:mr-4 file:py-2 file:px-4 file:rounded-l-md file:border-0 file:border-r-[1px] file:border-slate-100/10 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-500/70 hover:file:bg-200 group-[.form-inline]:flex-1 group-[.input-group]:rounded-none group-[.input-group]:[&:not(:first-child)]:border-l-transparent group-[.input-group]:first:rounded-l group-[.input-group]:last:rounded-r group-[.input-group]:z-10">
                                                <option selected disabled>-- Select --</option>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="text-left">
                                                    <div class="flex items-center">
                                                        <div class="font-medium">Open Date</div>
                                                        <div
                                                            class="ml-2.5 rounded-md border border-slate-200 bg-slate-100 px-2 py-0.5 text-xs text-slate-500 dark:bg-darkmode-300 dark:text-slate-400">
                                                            Required
                                                        </div>
                                                    ...
                                                    <div
                                                        class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                        Enter open date for the role.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <input data-tw-merge="" id="autocompleteN" type="date" name="open_date" value="{{$opening?->open_date}}"
                                                    placeholder="Enter open date"
                                                    class="disabled:bg-slate-100 disabled:cursor-not-allowed dark:disabled:bg-darkmode-800/50 dark:disabled:border-transparent [&[readonly]]:bg-slate-100 [&[readonly]]:cursor-not-allowed [&[readonly]]:dark:bg-darkmode-800/50 [&[readonly]]:dark:border-transparent transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 dark:placeholder:text-slate-500/80 [&[type='file']]:border file:mr-4 file:py-2 file:px-4 file:rounded-l-md file:border-0 file:border-r-[1px] file:border-slate-100/10 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-500/70 hover:file:bg-200 group-[.form-inline]:flex-1 group-[.input-group]:rounded-none group-[.input-group]:[&:not(:first-child)]:border-l-transparent group-[.input-group]:first:rounded-l group-[.input-group]:last:rounded-r group-[.input-group]:z-10 first:rounded-b-none last:-mt-px last:rounded-t-none focus:z-10 first:md:rounded-r-none first:md:rounded-bl-md last:md:-ml-px last:md:mt-0 last:md:rounded-l-none last:md:rounded-tr-md [&:not(:first-child):not(:last-child)]:-mt-px [&:not(:first-child):not(:last-child)]:rounded-none [&:not(:first-child):not(:last-child)]:md:-ml-px [&:not(:first-child):not(:last-child)]:md:-ml -px [&[type='file']]:border file:hover:bg-slate-gray">
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <div
                                                        class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                        Enter close date for the role.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <input data-tw-merge="" id="autocompleteN" type="date" name="application_deadline" value="{{$opening?->application_deadline}}"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <div
                                                        class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                        How much are you willing to pay for this role.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <input data-tw-merge="" type="number" name="salary" value="{{$opening?->salary}}"
                                                        placeholder="50.00"
                                                        class="disabled:bg-slate-100 disabled:cursor-not-allowed dark:disabled:bg-darkmode-800/50 dark:disabled:border-transparent [&[readonly]]:bg-slate-100 [&[readonly]]:cursor-not-allowed [&[readonly]]:dark:bg-darkmode-800/50 [&[readonly]]:dark:border-transparent transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 dark:placeholder:text-slate-500/80 [&[type='file']]:border file:mr-4 file:py-2 file:px-4 file:rounded-l-md file:border-0 file:border-r-[1px] file:border-slate-100/10 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-505/70 hover:file:bg-200 group-[.form-inline]:flex-1 group-[.input-group]:rounded-none group-[.input-group]:[&:not(:first-child)]:border-l-transparent group-[.input-group]:first:rounded-l group-[.input-group]:last:rounded-r group-[.input-group]:z-10 first:rounded-b-none last:-mt-px last:rounded-t-none focus:z-10 first:md:rounded-r-none first:md:rounded-bl-md last:md:-ml-px last:md:mt-0 last:md:rounded-l-none last:md:rounded-tr-md [&:not(:first-child):not(:last-child)]:-mt-px [&:not(:first-child):not(:last-child)]:rounded-none [&:not(:first-child):not(:last-child)]:md:-ml-px [&:not(:first-child):not(:last-child)]:md:-ml--px [&[type='file']]:border file:hover:bg-gray hover:bg-gray hover:bg-gray hover:bg-gray hover:bg-gray hover:bg-gray hover:bg-gray hover:bg-gray hover:bg-gray hover:bg-gray hover:bg-gray hover:bg-gray hover:bg-gray">
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <div
                                                        class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                        Enter the currency for the salary.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                                    <select name="currency" id="currency"
                                                        ...
                                                        <option value="USD" {{ $opening->currency == 'USD' ? 'selected' : '' }}>USD</option>
                                                        <option value="EUR" {{ $opening->currency == 'EUR' ? 'selected' : '' }}>EUR</option>
                                                        <option value="GBP" {{ $opening->currency == 'GBP' ? 'selected' : '' }}>GBP</option>
                                                    </select>
                                                    </div>
                                                </div>
                                        </div>
                                            ...
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <div class="flex flex-col items-center md:flex-row">
                                                    ...
                                                    <textarea data-tw-merge="" id="editor"
                                                        class="disabled:bg-slate-100 disabled:cursor-not-allowed dark:disabled:bg-darkmode-800/50 dark:disabled:border-transparent [&[readonly]]:bg-slate-100 [&[readonly]]:cursor-not-allowed [&[readonly]]:dark:bg-darkmode-800/50 [&[readonly]]:dark:border-transparent transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 dark:placeholder:text-slate-500/80 [&[type='file']]:border file:mr-4 file:py-2 file:px-4 file:rounded-l-md file:border-0 file:border-r-[1px] file:border-slate-100/10 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-500/70 hover:file:bg-200 group-[.form-inline]:flex-1 group-[.input-group]:rounded-none group-[.input-group]:[&:not(:first-child)]:border-l-transparent group-[.input-group]:first:rounded-l group-[.input-group]:last:rounded-r group-[.input-group]:z-10 first:rounded-b-none last:-mt-px last:rounded-t-none focus:z-10 first:md:rounded-r-none first:md:rounded-bl-md last:md:-ml-px last:md:mt-0 last:md:rounded-l-none last:md:rounded-tr-md [&:not(:first-child):not(:last-child)]:-mt-px [&:not(:first-child):not(:last-child)]:rounded-none [&:not(:first-child):not(:last-child)]:md:-ml-px [&:not(:first-child):not(:last-child)]:md:mt-0"
                                                        name="description" id="" cols="30" rows="10">{{$opening?->description}}</textarea>
