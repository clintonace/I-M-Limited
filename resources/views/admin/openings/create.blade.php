            ...
            <div class="container">
                <div class="grid grid-cols-12 gap-x-6 gap-y-10">
                    <div class="col-span-12 sm:col-span-10 sm:col-start-2">
                        ...
                        <form action="{{route('admin.create.opening')}}" enctype="multipart/form-data"
                            method="POST">
                                ...
                                <div class="box box--stacked flex flex-col">
                                    <div class="p-7">
                                        ...
                                        <div
                                            ...
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <div class="flex flex-col items-center md:flex-row">
                                                    <input data-tw-merge="" name="title" type="text"
                                        ...
                                        <div
                                            ...
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <input data-tw-merge="" id="autocompleteN" type="text" name="location"
                                        ...
                                        <div
                                            ...
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <input data-tw-merge="" id="autocompleteN" type="date" name="open_date"
                                        ...
                                        <div
                                            ...
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <input data-tw-merge="" id="autocompleteN" type="date" name="application_deadline"
                                        ...
                                        <div
                                            ...
                                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                                <input data-tw-merge="" type="number" name="salary"
                                                        placeholder="50.00"
