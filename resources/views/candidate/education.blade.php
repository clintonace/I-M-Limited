                    ...
                    <div class="col-span-12 sm:col-span-10 sm:col-start-2">
                        ...
                        <form action="{{route('candidate.education.update')}}" enctype="multipart/form-data"
                            ...
                            <div class="flex border-t border-slate-200/80 px-7 py-5 md:justify-end">
                                <a href="{{ route('candidate.profile.view') }}" class="transition duration-200 border shadow-sm inline-flex items-center justify-center py-2 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&:hover:not(:disabled)]:bg-opacity-90 [&:hover:not(:disabled)]:border-opacity-90 [&:not(button)]:text-center disabled:opacity-70 disabled:cursor-not-allowed text-primary dark:border-primary [&:hover:not(:disabled)]:bg-primary/10 w-full border-primary/50 px-10 md:w-auto">
                                ...
                                <button data-tw-merge="" type="submit"
                                    ...
                                    @if (Auth::user()?->edu && !Auth::user()->edu->isEmpty)
