                                    ...
                                    <div class="mt-3.5 grid grid-cols-12 gap-x-6 gap-y-10">
                                        ...
                                        <div
                                            ...
                                            <div class="mb-5 mt-1 leading-relaxed text-slate-500">
                                                Profile completion percentage - {{$t?->user?->info?->profile_completion_percentage}}%
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center">
                                                 ...
                                                 <div class="flex items-center">
                                                    ...
                                                    <div class="ml-auto text-slate-500">
                                                        {{$t?->user?->info?->first_name}} {{$t?->user?->info?->last_name}}
                                                    </div>
                                                </div>
                                                <div class="flex items-center">
                                                    <div class="text-slate-500">Skills:</div>
                                                    <div class="ml-auto text-slate-500">
                                                        {{$t?->user?->info?->professional_skills}}
                                                    </div>
                                                </div>
                                                <div class="flex items-center">
                                                    <div class="text-slate-500">Languages:</div>
                                                    <div class="ml-auto text-slate-500">
                                                        {{$t?->user?->info?->languages}}
                                                    </div>
                                                </div>
                                                <div class="flex items-center">
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-auto text-slate-500">
                                                        {{$t?->user?->info?->dob}}/{{$t?->user?->info?->age}}
                                                    </div>
                                                </div>
                                                <div class="flex items-center">
                                                    <div class="text-slate-500">Years of Exp:</div>
                                                    <div class="ml-auto text-slate-500">
                                                        {{$t?->user?->info?->experience_yr}}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ml-auto text-slate-500">
                                                        {{$t?->user?->info?->department}}
                                                    </div>
                                                </div>

                                              

                                                <form action="{{route('candidate.engagement.notification', $t?->user?->id)}}" method="post">

                                                  @csrf
                                                    <div class="w-full flex justify-center pt-4">
                                                        <input type="hidden" value="{{$t?->user?->id}}" name="user_id">
                                                        <input type="hidden" value="{{Auth::user()->company?->company_email}}" name="company_email">
                                                        <input type="hidden" value="{{Auth::user()->company?->company_name}}" name="company_name">
                                                        <input type="hidden" value="Dashboard engaegement request" name="message">
