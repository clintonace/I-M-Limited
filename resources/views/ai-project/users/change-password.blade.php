                                                ...
                                                <form action="{{route('ai-change-password')}}" method="POST">
                                                    ...
                                                    <div class="grid grid-cols-2 gap-4">
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <input data-tw-merge id="regular-form-6" name="name" type="text" value="{{$user?->name}}"
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <input data-tw-merge id="regular-form-6" readonly name="email" type="email" value="{{$user?->email}}"
                                                    ...
                                                    <div class="mt-3 flex flex-wrap gap-2">
                                                        <button data-tw-merge type="submit"
                                                            class="transition duration-200 border shadow-sm inline-flex items-center justify-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&:hover:not(:disabled)]:bg-opacity-90 [&:hover:not(:disabled)]:border-opacity-90 [&:not(button)]:text-center disabled:opacity-70 disabled:cursor-not-allowed bg-primary border-primary text-white dark:border-primary w-24 w-24">Update</button>
                                                    </div>
                                                </form>

                                                <div class="pt-4">
                                                    <div class="mt-2 sm:ml-auto sm:mt-0">
                                                        Note this will update your details.
                                                    </div>
                                                </div>
                                            </div>
