        ...
        <div class="auto-container">
          ...
          <div class="row">
            ...
            <div class="work-block col-lg-4 col-md-6 col-sm-12">
              <div class="inner-box">
                <figure class="image"><img src="/onboarding/images/resource/work-1.png" alt=""></figure>
            ...
            <div class="work-block col-lg-4 col-md-6 col-sm-12">
              <div class="inner-box">
                <figure class="image"><img src="/onboarding/images/resource/work-2.png" alt=""></figure>
            ...
            <div class="work-block col-lg-4 col-md-6 col-sm-12">
              <div class="inner-box">
                <figure class="image"><img src="/onboarding/images/resource/work-3.png" alt=""></figure>
      ...
      <section class="clients-section">
        <div class="sponsors-outer">
          ...
          <ul class="sponsors-carousel owl-carousel owl-theme">
            <li class="slide-item">
              <figure class="image-box"><a href="#"><img src="/onboarding/images/clients/1-1.png" alt=""></a></figure>
            </li>
            <li class="slide-item">
              <figure class="image-box"><a href="#"><img src="/onboarding/images/clients/1-2.png" alt=""></a></figure>
            </li>
            <li class="slide-item">
              <figure class="image-box"><a href="#"><img src="/onboarding/images/clients/1-3.png" alt=""></a></figure>
            </li>
            <li class="slide-item">
              <figure class="image-box"><a href="#"><img src="/onboarding/images/clients/1-4.png" alt=""></a></figure>
            </li>
            <li class="slide-item">
              <figure class="image-box"><a href="#"><img src="/onboarding/images/clients/1-5.png" alt=""></a></figure>
            </li>
            <li class="slide-item">
              <figure class="image-box"><a href="#"><img src="/onboarding/images/clients/1-6.png" alt=""></a></figure>
            </li>
            <li class="slide-item">
              <figure class="image-box"><a href="#"><img src="/onboarding/images/clients/1-7.png" alt=""></a></figure>
            </li>
          </ul>
        </div>
      </section>
